...
You're free to proceed in this course using any basic modelling software you like. 
We will be using Stan, so if you want to follow along you'll need to have it installed also! To do so, follow the steps [in this vignette](https://cran.r-project.org/web/packages/rstan/vignettes/rstan.html). Make sure you can run the example (up to "Sample from the Posterior Distribution") 
