...
normal_dist_rng_spp_yrep <- rstan::extract(normal_dist_rng_spp_samp, pars = "yrep")$yrep

# Posterior predictive check
bayesplot::ppc_dens_overlay(y = list_bill_dep$measurements, yrep = normal_dist_rng_spp_yrep[1:50, ])
```
