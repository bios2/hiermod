...
Another essential package for working with posterior samples is called [`bayesplot`](http://mc-stan.org/bayesplot/)
...
The distribution of the parameter here covers the real value of `r round(avg_birds_per_person, 2)` pretty well! 

We can look at this again with bayesplot
