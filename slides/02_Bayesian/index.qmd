...
[![](../img/Fantastic_Beast.png){width=1000 height=500}](https://youtu.be/OIN-dzeSMwc?si=3cM5IBe5MrQekNhT&t=34)
...
::: {style="font-size: 0.85em"}
We can assume the Binomial distribution is a good choice in this example.
:::
...
- $\theta$ represent the parameter(s) associated to the model
:::
...
If you do not fully get it (and even if you do), check out this [Brilliantly wrong](https://arogozhnikov.github.io/2016/12/19/markov_chain_monte_carlo.html) blog post.
...
![Stanisław Ulam](https://api.culture.pl/sites/default/files/styles/1920_auto/public/2018-12/stanislaw-ulam-gettyimages26.jpg?itok=tLdlB95q){width=70%}
...
* Extensive documentation :  [https://mc-stan.org/docs/](https://mc-stan.org/docs/)
* Large and active online community :  [https://discourse.mc-stan.org/](https://discourse.mc-stan.org/)
...
![](../img/sucre.jpg){fig-align="center" width=35%}
