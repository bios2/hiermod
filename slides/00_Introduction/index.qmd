...
## Dos and don'ts at the Gault Natural Reserve
...
Fires can only be started if the fire risk from the [SOPFEU at Mont St-Hilaire](https://www.sopfeu.qc.ca/en/current-situation/location/?name=Mont-Saint-Hilaire,+Mont-Saint-Hilaire;+La+Vall%C3%A9e-du-Richelieu,+Quebec+(City)&lat=45.56250155000001&lng=-73.16534650000001) is [Low]{style="color:blue;"} or [Moderate]{style="color:green;"}

. . .

If you start a fire when the fire risk is [High]{style="color:yellow;"}, [Very High]{style="color:orange;"} or [Extreme]{style="color:red;"} you will be evicted from the premises... and you will fail the course. 
...
Trails should not be used after sunsets
...
Pick-up after yourself both in the living areas, your rooms and outside
...
knitr::include_graphics("https://m.media-amazon.com/images/I/81cEpsiTCFL._SL1500_.jpg")
```
...
```{r echo=FALSE, out.width="30%", fig.align='center'}
knitr::include_graphics("https://m.media-amazon.com/images/I/61gjV8wBgpL.jpg")
```
