...
## Dos and don'ts at the Jouvence
...
We will ***not*** give an introduction to any programming language (e.g. R, Python, Julia). We assume you know one and are conformtable using it... We are more comfortable in R, but can work with many other languages (but please no Fortran !)
:::
