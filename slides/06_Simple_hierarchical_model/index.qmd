...
# Modelling hierarchy on the intercept
...
$$\mathbf{b} \sim \mathcal{N}(0, \sigma^2_{g\in f})$$
...
# Modelling hierarchy on the slopes
...
## Simple hierarchy on an intercept and a slope

Fundamentally, what are the differences ? Any idea ?
