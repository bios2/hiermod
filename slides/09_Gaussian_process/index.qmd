...
lapin <- readRDS("Repository/hiermod/slides/data/lapin.RDS")
explan <- readRDS("Repository/hiermod/slides/data/explanaNest.RDS")
mtl <- readRDS("Repository/hiermod/slides/data/mtl.RDS")
...
StackEst <- inla.stack(data=list(lapin = PA),
                       A = AEstlist,
                       effects = effectEst,
                       tag="est")
