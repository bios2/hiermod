...
$$\mathbf{y} \sim \mathcal{MVN}(\mathbf{b}_{0f} +\mathbf{z}\mathbf{b}_{1f},\mathbf{\Sigma})$$
or 
...
Your superviser thinks that Pumpkinseed growth is influenced by water temperature and knows that, because of the area and depth of lakes (which are also known for all these lakes), the different lakes have different average temperature.
