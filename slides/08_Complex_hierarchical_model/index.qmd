...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Pumpkinseed_%28Lepomis_gibbosus%29_%2813533753654%29.jpg/480px-Pumpkinseed_%28Lepomis_gibbosus%29_%2813533753654%29.jpg){fig-align="center" width=20%}
...
Your superviser thinks that Pumpkinseed growth is influenced by water temperature and knows that, because of their area and depth, the different lake have different temperature.
...
::: {style="font-size: 0.9em"}
Does the growth of Pumpkinseed is influenced by water temperature? To have the most precise model, we need to account  for lakes area and depth as well as control for the temperature variation in between lakes and for divergences in sampling measurements of each year (wink, wink... teachers assistant may have an influence here as well).
:::
...
So far, we have used "standard" model to build hierarchical models. 

Let's now develop a hierarchical model that does not follow the predefined structure we have studied so far.

A multivariate hierarchical model is a good example to show how wild we can go with hierarchical models.
