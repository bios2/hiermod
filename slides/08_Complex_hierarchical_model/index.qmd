...
interceptSlope <- MASS::mvrnorm(30, mu = mu, Sigma = sigma)
for(i in 1:30){
  abline(a = rnorm(1, mean = 1, sd = 0.2),
         b = rnorm(1, mean = 1, sd = 0.2),
         lwd = 3,
...
![](https://i0.wp.com/jalacoste.com/wp-content/uploads/2013/11/lego-1.jpg?w=600&ssl=1){fig-align="center" width=60%}
...
In the next few slides I will present an example of how to write the math to develop models that have multiple hierarchy.

As an example, let's get back to our favourite plant species *Bidonia examplaris*.

### Data

Let's say we sampled humidity at a 100 locations. Within these locations we also sampled the biomass of *B. examplaris* in 30 quadrates as well as soil pH.

### Question

How does biomass of *B. examplaris* changes 
