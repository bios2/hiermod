...
$$\mathbf{b} \sim \mathcal{MVN}\left(\begin{bmatrix}
                                    0\\
                                    0\\
                                  \end{bmatrix}
                                , 
...
$$\begin{bmatrix}
    ...
    b_1\\
\end{bmatrix}
\sim \mathcal{MVN}\left(\begin{bmatrix}
                                    0\\
                                    0\\
                                  \end{bmatrix}, 
                      \begin{bmatrix}
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Pumpkinseed_%28Lepomis_gibbosus%29_%2813533753654%29.jpg/1920px-Pumpkinseed_%28Lepomis_gibbosus%29_%2813533753654%29.jpg?_=20171204011653){fig-align="center" width=30%}

## Combining different types of hierarchy {style="font-size: 0.8em"}
**Fictive context**

Pumpkinseed (*Lepomis gibbosus*) growth has been studied in 15 lakes of the Eastern Township during the famous ichthyology course given at Université de Sherbrooke in the past 30 years. 
...
Is the size of Pumpkinseed influenced by water temperature? 
