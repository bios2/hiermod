...
The best way to do this is to immerse ourselve into a particular setting.
...
Does the growth of Pumpkinseed is influenced water temperature, which changed across lakes which accounting for lakes area and depth and controling for divergences in sampling measurements of each classes (wink, wink... teachers assistant may have an influence here)?
...
How should we build our model to answer our question given our sampling scheme ?
