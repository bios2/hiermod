...
At this point, the structure of the hierarchy discussed were "simple" in the sense that they either required to estimate
...
At this point, the covariance structure 
$$\begin{bmatrix}
    b_0\\
    b_1\\
\end{bmatrix}
